...
const Home: NextPage = () => {
  ...
  useEffect(() => {
    ...
    setIsFetching(!(domainName == finalDomainName));
      ...
      >
        <Box px="5">
          ...
          <Box mt="5">
            ...
            <NFTCard ethAddress={ensData.ethAddress || "0xd8FDf15e99b371214D6f1728C85f96635361978c"}></NFTCard>
          </Box>
        </Box>
