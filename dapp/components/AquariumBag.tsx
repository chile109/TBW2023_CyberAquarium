...
const SidebarFishBoxList = () => {
  return (
    <div>
      {fishBoxList.map((row, rowIndex) => (
        <div key={rowIndex} className="sidebarFish-fishBox-list-row">
          {row.map((item, itemIndex) => (
            <div key={itemIndex} className="sidebarFish-fishBox-list-row-item bgset">
              <div className="sidebarFish-fishBox-list-row-item-num">{item}</div>
            </div>
          ))}
        </div>
      ))}
